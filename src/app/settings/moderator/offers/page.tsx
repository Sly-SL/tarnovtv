            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-10" style={{animation:"fadeUp 0.5s cubic-bezier(0.16,1,0.3,1) both"}}>
                    ...
                    <div>
                        ...
                        <h1 className="text-3xl font-extrabold tracking-tight text-white">Zarządzaj ofertą</h1>
                        <p className="text-sm text-white/30 font-light mt-1">Dodawaj, edytuj i usuwaj pakiety współpracy.</p>
                    </div>
                    <button
                        onClick={openNew}
                        ...
                        {offers.map((offer) => (
                            ...
                            >
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-white/35 truncate mb-2">{offer.subtitle}</p>
                                    <p className="text-base font-extrabold text-white">{offer.price}</p>
                                </div>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                >
                                    <div className={[
                                        ...
                                        form.highlight ? "border-(--contrast-color) bg-(--contrast-color)/22" : "border-white/13 bg-white/[0.035]",
                                    ].join(" ")}>
                                    ...
                                    <span className="text-xs text-white/40">Wyróżniona karta</span>
                                </div>
