        ...
        <div className="relative min-h-screen w-full flex flex-col overflow-hidden">
            ...
            <div className="relative z-10 flex-1 px-4 sm:px-8 lg:px-12 py-6">
                <div className="max-w-screen-xl mx-auto">
                    ...
                    {users.length === 0 ? (
                        <div className="
                            rounded-3xl p-16 text-center backdrop-blur-2xl
                            border border-black/[0.07] bg-black/[0.028]
                            dark:border-white/[0.07] dark:bg-white/[0.028]
                        ">
                            <LockKeyOpenIcon size={32} className="text-black/15 dark:text-white/15 mx-auto mb-3"/>
                            <p className="text-sm text-black/25 dark:text-white/25">Brak zablokowanych kont</p>
                        </div>
                    ) : (
                        <div className="
                        ...
                        ">
                            <div className="hidden md:grid grid-cols-[1fr_2fr_80px_120px] gap-4 px-6 py-3 border-b border-black/[0.05] dark:border-white/[0.05] text-[10px] font-medium tracking-widest uppercase text-black/25 dark:text-white/25">
                            ...
                            {users.map((user, i) => (
                                <div
                                    key={user.id}
                                    className={[
                                        "grid grid-cols-1 md:grid-cols-[1fr_2fr_80px_120px] gap-4 px-6 py-4 items-center hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors",
                                        i !== users.length - 1 ? "border-b border-black/[0.04] dark:border-white/[0.04]" : "",
                                    ].join(" ")}
                                >
