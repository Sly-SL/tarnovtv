        ...
        <div className="relative min-h-screen w-full flex flex-col overflow-hidden">
            ...
            <div className="relative z-10 px-4 sm:px-8 lg:px-12 pt-8 pb-6 border-b border-white/[0.06]">
                <div className="max-w-screen-xl mx-auto">
                    <Link href={shortcuts.settings} className="inline-flex items-center gap-2 text-xs text-white/30 hover:text-white/60 transition-colors mb-6">
                            ...
                            <div
                                ...
                                className={`mt-0.5 w-5 h-5 flex-shrink-0 rounded-md border transition-all duration-150 flex items-center justify-center ${
                                    confirmed
                                        ...
                                        : "border-white/20 bg-white/[0.03] group-hover:border-red-500/40"
                                }`}
                            >
                                {confirmed && (
