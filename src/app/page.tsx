      ...
      <div className="flex flex-col flex-1 items-center justify-center">
        <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 sm:items-start">
          ...
          <div className="flex flex-col gap-4 pt-5 text-base font-medium sm:flex-row">
            ...
            <a
                className="flex h-12 w-full items-center justify-center rounded-full border border-solid border-black/[.08] px-5 gap-2 transition-colors hover:border-transparent hover:bg-black/[.04] dark:border-white/[.145] dark:hover:bg-[#1a1a1a] md:w-[158px]"
                href="https://www.tiktok.com/@tarnovtv?lang=en-GB"
                target="_blank"
                rel="noopener noreferrer"
            >
