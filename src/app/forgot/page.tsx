...
const ForgetPage = () => {
    return (
        <div className="relative min-h-screen flex items-center justify-center px-4 py-16 overflow-hidden">
            ...
            <div
                className="relative z-10 w-full max-w-[440px] rounded-3xl border border-white/[0.07] bg-white/[0.028] backdrop-blur-2xl shadow-[0_32px_72px_rgba(0,0,0,0.55),0_0_0_1px_rgba(255,255,255,0.035)_inset] p-10"
                ...
                <div className="flex flex-col gap-2">
                    {options.map((opt) => (
                        <Link
                            key={opt.href}
                            href={opt.href}
                            className="group flex items-center gap-4 px-4 py-3.5 rounded-2xl border border-white/[0.06] bg-white/[0.018] hover:border-(--contrast-color)/30 hover:bg-(--contrast-color)/[0.05] transition-all duration-150"
                        >
                            <div className="flex-shrink-0 w-9 h-9 rounded-xl flex items-center justify-center bg-white/[0.04] border border-white/[0.06] group-hover:border-(--contrast-color)/25 group-hover:bg-(--contrast-color)/10 transition-all duration-150 text-white/40 group-hover:text-(--contrast-color)">
                                {opt.icon}
                            </div>
                            ...
                            <div className="text-white/15 group-hover:text-(--contrast-color)/50 group-hover:translate-x-0.5 transition-all duration-150">
